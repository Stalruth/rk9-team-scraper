...
parser.add_argument('matched_output')
parser.add_argument('unmatched_output')
...
if __name__ == '__main__':
    ...
    players_out = {}
    try:
        with open(args.matched_output, 'r') as infile:
    ...
    players_left = [i for i in players if i not in players_out]
    ...
    with open(args.matched_output, 'w') as outfile:
        json.dump(players_out, outfile, indent=2, ensure_ascii=False)

    with open(args.unmatched_output, 'w') as outfile:
        json.dump({
            'roster': roster_players,
            'pairings': {i: {'pairingsName': players[i]['name']} for i in players_left}
